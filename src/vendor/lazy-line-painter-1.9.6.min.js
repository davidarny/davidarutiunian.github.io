                ...
                (n.emit = function(t, e) {
                    if (
                        ...
                        try {
                            for (
                                var r,
                                    a = this._eventEmitterCallbacks[t][
                                        Symbol.iterator
                                    ]();
                                !(i = (r = a.next()).done);
                                i = !0
                    ...
                    (function(t, e, i) {
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                (this.config.totalDuration = this.config
                                    .drawSequential
                                    ? t
                                    : e),
                            ...
                            value: function() {
                                ...
                                for (var t = 0; t < this.__paths.length; t++) {
                                    ...
                                    e.el.getBoundingClientRect(),
                                        (e.positions = this._getPathPoints(
                                            e.el,
                                            e.length
                                        )),
                            ...
                            value: function() {
                                for (var t = 0; t < this.__paths.length; t++) {
                                    ...
                                    (e.id = e.el.dataset.llpId),
                                        (e.delay =
                                            Number(e.el.dataset.llpDelay) || 0),
                                        (e.duration =
                                            Number(e.el.dataset.llpDuration) ||
                                            0),
                                        (e.reverse =
                                            Boolean(e.el.dataset.llpReverse) ||
                                            !1),
                                        (e.ease =
                                            Number(e.el.dataset.llpEase) ||
                                            null),
                                        (e.strokeDash =
                                            e.el.dataset.llpStrokeDash || null),
                        ...
                        },
                        {
                            ...
                            value: function(t) {
                                (t.strokeColor =
                                    t.el.dataset.llpStrokeColor ||
                                    this.config.strokeColor),
                                    t.strokeColor &&
                                        (t.el.style.stroke = t.strokeColor),
                                    (t.strokeOpacity =
                                        t.el.dataset.llpStrokeOpacity ||
                                        this.config.strokeOpacity),
                                    t.strokeOpacity &&
                                        (t.el.style.strokeOpacity =
                                            t.strokeOpacity),
                                    (t.strokeWidth =
                                        t.el.dataset.llpStrokeWidth ||
                                        this.config.strokeWidth),
                                    t.strokeWidth &&
                                        (t.el.style.strokeWidth =
                                            t.strokeWidth),
                                    (t.strokeCap =
                                        t.el.dataset.llpStrokeCap ||
                                        this.config.strokeCap),
                                    t.strokeCap &&
                                        (t.el.style.strokeLinecap =
                                            t.strokeCap),
                                    (t.strokeJoin =
                                        t.el.dataset.llpStrokeJoin ||
                                        this.config.strokeJoin),
                                    t.strokeJoin &&
                                        (t.el.style.strokeLinejoin =
                                            t.strokeJoin);
                            },
                        },
                        {
